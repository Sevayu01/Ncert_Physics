const QuickNavigationButton = ({ idx, selected }) => {
  ...
  const correctStyle =
    "w-16 h-16 rounded-full border-[5px] border-white bg-green-500 text-white font-bold text-center text-xl flex justify-center items-center";
  const incorrectStyle =
    "w-16 h-16 rounded-full border-[5px] border-white bg-red-500 text-white font-bold text-center text-xl flex justify-center items-center";
